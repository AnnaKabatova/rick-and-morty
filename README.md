...
- Run celery worker for tasks handling: `celery -A rick_and_morthy worker -l INFO`
- Run celery beat for task scheduling: `celery -A rick_and_morthy beat -l INFO --scheduler django_celery_beat.schedulers:DatabaseScheduler`
